		   ...
		   <div class="regi_log row">
			...
			<form name="frm" method="post" action="insert" enctype="multipart/form-data">
				<div class="customer_register">
					<div class="info">
						<dl>
							<dd><input type="text" name="name" maxlength="10" placeholder="이름을 입력해주세요" /></dd>
						</dl>
						<dl>
							<dd><input type="text" name="address" maxlength="50" placeholder="주소를 입력해주세요" /></dd>
						</dl>
						<dl>
							<dd><input type="text" name="phone" maxlength="50" placeholder="전화번호를 입력해주" /></dd>
						</dl>
						<dl>
							<dd>
						...
						<dl>
							<dd><input type="text" name="age" maxlength="10" placeholder="나이입력" /></dd>
						</dl>
						<dl>
						<dd>
							<label style="font-size: 1.4rem; padding-right: 20px; margin-bottom: 10px;" for="file">프로필 업로드</label>
							<input type="file" name="file" id="file" />
						</dd>
						</dl>
						<dl>
							<dd><input type="text" name="point" maxlength="10" placeholder="점수입력" /></dd>
						</dl>
						<dl>
							<dd>
			...
			<div class="bt_wrap">
				<a onclick = "chkForm(); return false;" class="on log__btn">등록</a>
